...
hexo.extend.helper.register('website_github_edit_url', function (path) {
  ...
  if (path.indexOf('docs/') !== -1) {
    return urljoin(this.config.github.imersysdocs.url, 'edit', 'master/src/',
...
hexo.extend.helper.register('docs_active_version', function (page) {
  ...
  if (docIndex === -1) { return hexo.config.imersysdocs_version; }
...
/**
 * Return list of Docs versions, including `master`.
